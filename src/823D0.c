...
void func_8008191C(s32 arg0){
    ...
    switch(D_800E69C0.unk3C.uchar[0]){
        case 0:
            if(D_800F3940[cdata.unk41]->unk0.unk0[12] == 1){
        ...
        case 1:
            ...
            break;
        case 2:
            if((D_800F3940[cdata.unk41]->unk0.unk0[12] == 1 && D_800E69C0.unk3E[1].uchar[0] & 2) || (&D_800E6A2C)[D_800E69C0.unk3E[1].uchar[1]][0] > 0x37){
                if(D_800F3940[cdata.unk41]->unk0.unk0[12] == 1){
                    func_80008C6C(0xAD,0);
                }
                else{
